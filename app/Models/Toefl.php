...
class Toefl extends Model
{
    ...
    // ada direction ada imageable, belum nemu fitur rich text yg bisa akomodir gambar dalam text area, krn berbayar. yg dikomentari itu ga ada gunanya, ga jd inputan
    protected $fillable = [
        'title',
        'duration',
        // 'section_1_direction',
