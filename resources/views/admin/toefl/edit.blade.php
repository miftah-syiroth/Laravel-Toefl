                                ...
                                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                                    <div class="grid grid-cols-3 gap-6">
                                        <div class="col-span-3 sm:col-span-2">
                                            ...
                                            <div class="mt-1 flex rounded-md shadow-sm">
                                                <input type="text" name="title" id="title" value="{{ $toefl->title ?? old('title') }}" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-md sm:text-sm border-gray-300 @error('title') is-invalid @enderror">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="border-2 rounded-lg p-2">
                                        ...
                                        <div class="py-2 border-b">
                                            ...
                                            @enderror
                                            <div class="mt-1">
                                                <input type="file" name="section_1_track" id="section_1_track" value="{{ $toefl->section_1_track ?? old('section_1_track') }}" class="form-input mt-1 block w-full" placeholder="Jane Doe">
                                            </div>
                                        </div>
                                        ...
                                        <div class="py-2 border-b">
                                            ...
                                            @enderror
                                            <div class="mt-1">
                                                <input type="file" name="part_a_track" id="part_a_track" value="{{ $toefl->part_a_track ?? old('part_a_track') }}" class="form-input mt-1 block w-full" placeholder="Jane Doe">
                                            </div>                                            
                                        </div>
                                        ...
                                        <div class="py-2 border-b">
                                            ...
                                            @enderror
                                            <div class="mt-1">
                                                <textarea id="section_1_direction" name="section_1_direction" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md">{{ $toefl->section_1_direction ?? old('section_1_direction') }}</textarea>
                                            </div>
                                        ...
                                        <div class="py-2 border-b">
                                            ...
                                            @enderror
                                            <div class="mt-1">
                                                <textarea id="part_a_direction" name="part_a_direction" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md">{{ $toefl->part_a_direction ?? old('part_a_direction') }}</textarea>
                                            </div>
                                        ...
                                        <div class="py-2 border-b">
                                            ...
                                            @enderror
                                            <div class="mt-1">
                                                <textarea id="part_b_direction" name="part_b_direction" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md">{{ $toefl->part_b_direction ?? old('part_b_direction') }}</textarea>
                                            </div>
                                        ...
                                        <div class="py-2 border-b">
                                            ...
                                            @enderror
                                            <div class="mt-1">
                                                <textarea id="part_c_direction" name="part_c_direction" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md">{{ $toefl->part_c_direction ?? old('part_c_direction') }}</textarea>
                                            </div>
                                    ...
                                    <div class="border-2 rounded-lg p-2">
                                        ...
                                        <div class="py-2 border-b">
                                            ...
                                            @enderror
                                            <div class="mt-1">
                                                <textarea id="section_2_direction" name="section_2_direction" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md">{{ $toefl->section_2_direction ?? old('section_2_direction') }}</textarea>
                                            </div>
                                        ...
                                        <div class="py-2 border-b">
                                            ...
                                            @enderror
                                            <div class="mt-1">
                                                <textarea id="structure_direction" name="structure_direction" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md">{{ $toefl->structure_direction ?? old('structure_direction') }}</textarea>
                                            </div>
                                        ...
                                        <div class="py-2 border-b">
                                            ...
                                            @enderror
                                            <div class="mt-1">
                                                <textarea id="written_expression_direction" name="written_expression_direction" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md">{{ $toefl->written_expression_direction ?? old('written_expression_direction') }}</textarea>
                                            </div>
                                    ...
                                    <div class="border-2 rounded-lg p-2">
                                        ...
                                        <div class="py-2 border-b">
                                            ...
                                            @enderror
                                            <div class="mt-1">
                                                <textarea id="section_3_direction" name="section_3_direction" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md">{{ $toefl->section_3_direction ?? old('section_3_direction') }}</textarea>
                                            </div>
