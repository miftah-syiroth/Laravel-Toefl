<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="/participant/{{ $kelas->id }}" enctype="multipart/form-data">
            ...
            <div class="mt-4">
                <x-jet-label for="receipt_of_payment" value="{{ __('Bukti Pembayaran') }}" />
                {{-- <input type="file" name="" id=""> --}}
                <x-jet-input type="file" id="receipt_of_payment" class="block mt-1 w-full" name="receipt_of_payment" />
            </div>
