    ...
    <div class="border-t border-gray-200">
        <dl>
            ...
            <div class="bg-white px-4 py-2 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                ...
                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                    : {{ $kelas->pelaksanaan->isoFormat('H:mm, dddd, D MMMM Y') }} ({{ $kelas->pelaksanaan->diffForHumans() }}) 
                </dd>
            </div>
            <div class="bg-white px-4 py-2 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt class="text-sm font-medium text-gray-500">
            ...
            @can('mengerjakan toelf')
            <div class="bg-white px-4 py-2 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt class="text-sm font-medium text-gray-500">
                    Lembar Kerja TOEFL
                </dt>
                <dd class="mt-1 text-sm font-semibold text-gray-900 sm:mt-0 sm:col-span-2">
                    : <button class="py-1 px-2 bg-indigo-600 rounded-lg text-white">mulai soal</button>
                </dd>
            </div>
            @endcan
