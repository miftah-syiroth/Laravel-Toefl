...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    Route::prefix('/participant')->middleware(['role:participant'])->group(function () {
        ...
        Route::get('/dashboard', ToeflInformation::class)->name('participant.dashboard');

        Route::group(['middleware' => ['permission:mengerjakan toefl']], function () {
    ...
    Route::prefix('/admin')->middleware(['role:admin'])->group(function () {
        ...
        Route::get('/kelas/{kelas}', KelasShow::class)->name('kelas.show');
